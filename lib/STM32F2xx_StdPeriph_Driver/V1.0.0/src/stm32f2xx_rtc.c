...
ErrorStatus RTC_Init(RTC_InitTypeDef* RTC_InitStruct)
{
  ...
  assert(IS_RTC_HOUR_FORMAT(RTC_InitStruct->RTC_HourFormat));
  assert(IS_RTC_ASYNCH_PREDIV(RTC_InitStruct->RTC_AsynchPrediv));
  assert(IS_RTC_SYNCH_PREDIV(RTC_InitStruct->RTC_SynchPrediv));
...
ErrorStatus RTC_SetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  ...
  /* Check the parameters */
  assert(IS_RTC_FORMAT(RTC_Format));
  
  if (RTC_Format == RTC_Format_BIN)
  {
    if ((RTC->CR & RTC_CR_FMT) != (uint32_t)RESET)
    {
      assert(IS_RTC_HOUR12(RTC_TimeStruct->RTC_Hours));
      assert(IS_RTC_H12(RTC_TimeStruct->RTC_H12));
    } 
    else
    {
      RTC_TimeStruct->RTC_H12 = 0x00;
      assert(IS_RTC_HOUR24(RTC_TimeStruct->RTC_Hours));
    }
    assert(IS_RTC_MINUTES(RTC_TimeStruct->RTC_Minutes));
    assert(IS_RTC_SECONDS(RTC_TimeStruct->RTC_Seconds));
  }
  else
  {
    if ((RTC->CR & RTC_CR_FMT) != (uint32_t)RESET)
    {
      ...
      assert(IS_RTC_HOUR12(tmpreg));
      assert(IS_RTC_H12(RTC_TimeStruct->RTC_H12)); 
    } 
    else
    {
      RTC_TimeStruct->RTC_H12 = 0x00;
      assert(IS_RTC_HOUR24(RTC_Bcd2ToByte(RTC_TimeStruct->RTC_Hours)));
    }
    assert(IS_RTC_MINUTES(RTC_Bcd2ToByte(RTC_TimeStruct->RTC_Minutes)));
    assert(IS_RTC_SECONDS(RTC_Bcd2ToByte(RTC_TimeStruct->RTC_Seconds)));
  }
...
ErrorStatus RTC_SetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
  ...
  if (RTC_Format == RTC_Format_BIN)
  {
    assert(IS_RTC_YEAR(RTC_DateStruct->RTC_Year));
    assert(IS_RTC_MONTH(RTC_DateStruct->RTC_Month));
    assert(IS_RTC_DATE(RTC_DateStruct->RTC_Date));
  }
  else
  {
    assert(IS_RTC_YEAR(RTC_Bcd2ToByte(RTC_DateStruct->RTC_Year)));
    tmpreg = RTC_Bcd2ToByte(RTC_DateStruct->RTC_Month);
    assert(IS_RTC_MONTH(tmpreg));
    tmpreg = RTC_Bcd2ToByte(RTC_DateStruct->RTC_Date);
    assert(IS_RTC_DATE(tmpreg));
  }
  assert(IS_RTC_WEEKDAY(RTC_DateStruct->RTC_WeekDay));
...
void RTC_SetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm, RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  ...
  /* Check the parameters */
  assert(IS_RTC_FORMAT(RTC_Format));
  assert(IS_RTC_ALARM(RTC_Alarm));
  assert(IS_ALARM_MASK(RTC_AlarmStruct->RTC_AlarmMask));
  assert(IS_RTC_ALARM_DATE_WEEKDAY_SEL(RTC_AlarmStruct->RTC_AlarmDateWeekDaySel));

  if (RTC_Format == RTC_Format_BIN)
  {
    if ((RTC->CR & RTC_CR_FMT) != (uint32_t)RESET)
    {
      assert(IS_RTC_HOUR12(RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours));
      assert(IS_RTC_H12(RTC_AlarmStruct->RTC_AlarmTime.RTC_H12));
    } 
    else
    {
      RTC_AlarmStruct->RTC_AlarmTime.RTC_H12 = 0x00;
      assert(IS_RTC_HOUR24(RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours));
    }
    assert(IS_RTC_MINUTES(RTC_AlarmStruct->RTC_AlarmTime.RTC_Minutes));
    assert(IS_RTC_SECONDS(RTC_AlarmStruct->RTC_AlarmTime.RTC_Seconds));
    
    if(RTC_AlarmStruct->RTC_AlarmDateWeekDaySel == RTC_AlarmDateWeekDaySel_Date)
    {
      assert(IS_RTC_ALARM_DATE_WEEKDAY_DATE(RTC_AlarmStruct->RTC_AlarmDateWeekDay));
    }
    else
    {
      assert(IS_RTC_ALARM_DATE_WEEKDAY_WEEKDAY(RTC_AlarmStruct->RTC_AlarmDateWeekDay));
    }
  }
  else
  {
    ...
    {
      RTC_AlarmStruct->RTC_AlarmTime.RTC_H12 = 0x00;
      assert(IS_RTC_HOUR24(RTC_Bcd2ToByte(RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours)));
    }
    
    assert(IS_RTC_MINUTES(RTC_Bcd2ToByte(RTC_AlarmStruct->RTC_AlarmTime.RTC_Minutes)));
    assert(IS_RTC_SECONDS(RTC_Bcd2ToByte(RTC_AlarmStruct->RTC_AlarmTime.RTC_Seconds)));
    
    if(RTC_AlarmStruct->RTC_AlarmDateWeekDaySel == RTC_AlarmDateWeekDaySel_Date)
    {
      tmpreg = RTC_Bcd2ToByte(RTC_AlarmStruct->RTC_AlarmDateWeekDay);
      assert(IS_RTC_ALARM_DATE_WEEKDAY_DATE(tmpreg));    
    }
    else
    {
      tmpreg = RTC_Bcd2ToByte(RTC_AlarmStruct->RTC_AlarmDateWeekDay);
      assert(IS_RTC_ALARM_DATE_WEEKDAY_WEEKDAY(tmpreg));      
    }    
  }
...
ErrorStatus RTC_AlarmCmd(uint32_t RTC_Alarm, FunctionalState NewState)
{
  ...
  /* Check the parameters */
  assert(IS_RTC_CMD_ALARM(RTC_Alarm));
  assert(IS_FUNCTIONAL_STATE(NewState));
...
{
  /* Check the parameters */
  assert(IS_RTC_WAKEUP_CLOCK(RTC_WakeUpClock));
...
{
  /* Check the parameters */
  assert(IS_RTC_WAKEUP_COUNTER(RTC_WakeUpCounter));
...
{
  /* Check the parameters */
  assert(IS_RTC_DAYLIGHT_SAVING(RTC_DayLightSaving));
  assert(IS_RTC_STORE_OPERATION(RTC_StoreOperation));
...
{
  /* Check the parameters */
  assert(IS_RTC_OUTPUT(RTC_Output));
  assert(IS_RTC_OUTPUT_POL(RTC_OutputPolarity));
...
ErrorStatus RTC_CoarseCalibConfig(uint32_t RTC_CalibSign, uint32_t Value)
{
  ...
  /* Check the parameters */
  assert(IS_RTC_CALIB_SIGN(RTC_CalibSign));
  assert(IS_RTC_CALIB_VALUE(Value)); 
...
void RTC_TimeStampCmd(uint32_t RTC_TimeStampEdge, FunctionalState NewState)
{
  ...
  /* Check the parameters */
  assert(IS_RTC_TIMESTAMP_EDGE(RTC_TimeStampEdge));
  assert(IS_FUNCTIONAL_STATE(NewState));
...
{
  /* Check the parameters */
  assert(IS_RTC_TAMPER(RTC_Tamper)); 
  assert(IS_RTC_TAMPER_TRIGGER(RTC_TamperTrigger));
...
{
  /* Check the parameters */
  assert(IS_RTC_TAMPER_PIN(RTC_TamperPin));
...
{
  /* Check the parameters */
  assert(IS_RTC_TIMESTAMP_PIN(RTC_TimeStampPin));
...
{
  /* Check the parameters */
  assert(IS_RTC_OUTPUT_TYPE(RTC_OutputType));
...
{
  /* Check the parameters */
  assert(IS_RTC_CONFIG_IT(RTC_IT));
  assert(IS_FUNCTIONAL_STATE(NewState));
