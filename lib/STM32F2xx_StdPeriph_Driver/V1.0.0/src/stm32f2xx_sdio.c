...
void SDIO_Init(SDIO_InitTypeDef* SDIO_InitStruct)
{
  ...
  assert(IS_SDIO_CLOCK_EDGE(SDIO_InitStruct->SDIO_ClockEdge));
  assert(IS_SDIO_CLOCK_BYPASS(SDIO_InitStruct->SDIO_ClockBypass));
  assert(IS_SDIO_CLOCK_POWER_SAVE(SDIO_InitStruct->SDIO_ClockPowerSave));
  assert(IS_SDIO_BUS_WIDE(SDIO_InitStruct->SDIO_BusWide));
  assert(IS_SDIO_HARDWARE_FLOW_CONTROL(SDIO_InitStruct->SDIO_HardwareFlowControl)); 
...
{
  /* Check the parameters */
  assert(IS_SDIO_POWER_STATE(SDIO_PowerState));
...
void SDIO_SendCommand(SDIO_CmdInitTypeDef *SDIO_CmdInitStruct)
{
  ...
  /* Check the parameters */
  assert(IS_SDIO_CMD_INDEX(SDIO_CmdInitStruct->SDIO_CmdIndex));
  assert(IS_SDIO_RESPONSE(SDIO_CmdInitStruct->SDIO_Response));
  assert(IS_SDIO_WAIT(SDIO_CmdInitStruct->SDIO_Wait));
  assert(IS_SDIO_CPSM(SDIO_CmdInitStruct->SDIO_CPSM));
...
void SDIO_DataConfig(SDIO_DataInitTypeDef* SDIO_DataInitStruct)
{
  ...
  /* Check the parameters */
  assert(IS_SDIO_DATA_LENGTH(SDIO_DataInitStruct->SDIO_DataLength));
  assert(IS_SDIO_BLOCK_SIZE(SDIO_DataInitStruct->SDIO_DataBlockSize));
  assert(IS_SDIO_TRANSFER_DIR(SDIO_DataInitStruct->SDIO_TransferDir));
  assert(IS_SDIO_TRANSFER_MODE(SDIO_DataInitStruct->SDIO_TransferMode));
  assert(IS_SDIO_DPSM(SDIO_DataInitStruct->SDIO_DPSM));
...
{
  /* Check the parameters */
  assert(IS_SDIO_READWAIT_MODE(SDIO_ReadWaitMode));
...
{ 
  /* Check the parameters */
  assert(IS_SDIO_CLEAR_FLAG(SDIO_FLAG));
...
{ 
  /* Check the parameters */
  assert(IS_SDIO_CLEAR_IT(SDIO_IT));
