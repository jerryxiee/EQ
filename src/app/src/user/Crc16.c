...
#include "Crc16.h"
/**************全局变量****************/
const unsigned char c_apucCRC16Hi[256] =
{
...
const unsigned char c_apucCRC16Lo[256] =
{
...
{
	unsigned char nCRCHi = 0xFF;
	unsigned char nCRCLo = 0xFF;
	unsigned char nIndex ;
	while(nData--)
	{
		nIndex = nCRCHi ^ *pData++;
		nCRCHi = nCRCLo ^ c_apucCRC16Hi[nIndex];
		nCRCLo = c_apucCRC16Lo[nIndex];
	}
